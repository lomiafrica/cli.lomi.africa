...
command
  ...
  .action(async () => {
    ...
    try {
      ...
      console.log(chalk.blue('Verification Token:'), webhook.verification_token);
    } catch (error) {
  ...
  .action(async (options) => {
    ...
    try {
      ...
      webhooks.forEach((webhook) => {
        ...
        console.log(chalk.blue('URL:'), webhook.url);
        console.log(chalk.blue('Events:'), webhook.authorized_events.join(', '));
        console.log(chalk.blue('Status:'), webhook.is_active ? 'Active' : 'Inactive');
        console.log(chalk.blue('Last Triggered:'), webhook.last_triggered_at || 'Never');
      });
    } catch (error) {
